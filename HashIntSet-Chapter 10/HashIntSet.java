...
public class HashIntSet {
    ...
    public void addAll(HashIntSet Set)
    {
        ...
        {
            HashEntry copySet= Set.elementData[i];

            while(copySet!=null)
            {
                if(!this.contains(copySet.data))
                {
                    this.add(copySet.data);
                }
                copySet=copySet.next;
            }
        }
    }
